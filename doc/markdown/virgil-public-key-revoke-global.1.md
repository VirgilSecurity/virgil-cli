...
-f <file>, --validated-identity <file> (accepted multiple times) (OR required) Validated Identity, see 'virgil identity-confirm-global' -- OR -- -d <arg>, --identity <arg> (accepted multiple times) (OR required) Identity user, for example: -d email:alice@domain.com
...
--, --ignore\_rest Ignores the rest of the labeled arguments following this flag.
